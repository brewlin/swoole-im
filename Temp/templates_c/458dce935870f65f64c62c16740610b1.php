<?php /*a:3:{s:60:"/website/talk/App/HttpController/Views/Admin/admin/edit.html";i:1530869960;s:63:"/website/talk/App/HttpController/Views/Admin/public/header.html";i:1531102388;s:63:"/website/talk/App/HttpController/Views/Admin/public/footer.html";i:1531101896;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-6" style="width: 100%;">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="x-form" action="#">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select class="input-sm form-control input-s-sm inline" name="role_id">
                                    <?php if(is_array($list['role']) || $list['role'] instanceof \think\Collection || $list['role'] instanceof \think\Paginator): $i = 0; $__LIST__ = $list['role'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $list['role_id']): ?> selected="selected"<?php endif; ?>><?php echo htmlentities($vo['name']); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input id="username" name="username" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error" value="<?php echo htmlentities($list['username']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">昵称：</label>
                            <div class="col-sm-8">
                                <input id="nickname" name="nickname" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error" value="<?php echo htmlentities($list['nickname']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">E-mail：</label>
                            <div class="col-sm-8">
                                <input id="email" name="email" value="<?php echo htmlentities($list['email']); ?>" class="form-control" type="email">
                            </div>
                        </div>
                        <div class="form-group">
